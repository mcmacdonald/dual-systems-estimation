...
The contents of the third file ('03_DSE.R') uses police-reported crime incidents and self-reported information about victimization from the General Social Survey to estimate the probability than an incident is known to the police. It uses logistic regression to estimate this probability distribution by type of crime, controlling for other factors that affect reporting/non-reporting to the police ([View Figure](https://github.com/mcmacdonald/dual-systems-estimation/blob/main/fig01.png)).
